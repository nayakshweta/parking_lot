...
class ParkingLotShell(cmd.Cmd):
    ...
    def do_park(self, args):
        ...
        self.parking_lot.get_new_ticket(args_list[0], args_list[1], args_list[2])
    
    def do_leave(self, args):
        args_list = args.split()
        self.parking_lot.return_parking_ticket(args_list[0], args_list[1])
    
    def do_status(self, args):
        self.parking_lot.get_parking_status()
    
    def do_registration_numbers_for_vehicles_with_colour(self, args):
        self.parking_lot.get_reg_numbers_for_vehicles_with_color(args)
    
    def do_slot_numbers_for_vehicles_with_colour(self, args):
        self.parking_lot.get_slot_numbers_for_vehicles_with_color(args)
